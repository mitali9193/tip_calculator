...
class TipCalculator():
    def __init__(self):
        ...
        window.configure(backgroung="sky blue")
        ...
        tip_percernts = Label(window,text="Tip Percentage",bg="purple",fg="white")
        tip_percernts.grid(column=0,row=0,padx=15)
        ...
        ten_percent_tip = Radiobutton(window,text="0.10%",variable = self.tip_percent,value =10)
        ten_percent_tip.grid(column=0,row=2)
        fifteen_percent_tip = Radiobutton(window,text="0.15%",variable = self.tip_percent,value =15)
        fifteen_percent_tip.grid(column=0,row=3)
        twenty_percent_tip = Radiobutton(window,text="0.20%",variable = self.tip_percent,value =20)
        twenty_percent_tip.grid(column=0,row=4)
        twentyfive_percent_tip = Radiobutton(window,text="0.25%",variable = self.tip_percent,value =25)
        twentyfive_percent_tip.grid(column=0,row=5)
        thirty_percent_tip = Radiobutton(window,text="0.30%",variable = self.tip_percent,value =30)
        ...
        tip_amount_entry.grid(column=2,rows=3)

        bill_total_lbl =Label(window, text="Tip Amount",bg="blue",fg="white")
        bill_total_lbl.grid(column=1,row=5,padx=15)
        bill_total_entry = Entry(window,textvariable = self.total_cost,width =14)
        bill_total_entry.grid(column=2,rows=5)
